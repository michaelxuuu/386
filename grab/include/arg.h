...
// Initialize 'ap' with 'last,' where 'last' is the first argument pushed onto
// the stack and thus is at the lowest address. Take the arguably most commonly
// used example, printf(char *s, ...), where 'last' would be 's'. 'ap' is of
// type 'va_list', aka. char*.
